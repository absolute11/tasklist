...
public class UserDto {
    ...
    @Schema(description = "User crypted password",
            example = "$2a$10$ENLl3Fg6PEFIeKAaXvlAU.1"
                    + "Ynp03sH.asVGsPylAz.RkBWxcKlT7O")
    ...
    @Schema(description = "user password confirmation",
            example = "$2a$10$ENLl3Fg6PEFIe"
                    + "KAaXvlAU.1Ynp03sH.asVGsPylAz.RkBWxcKlT7O")
